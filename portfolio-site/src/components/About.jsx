...
export default function About() {
    return (
        <div id="about" className="w-[100vw] md:w-full h-[100vh] py-6 flex flex-col items-center md:flex-row">
            <div className="w-[90%] md:w-[48%] flex items-center justify-center">
                <div className="w-[300px] h-[300px] md:w-[500px] md:h-[500px] object-cover rounded-full relative bg-lime-600">
                    <img
            ...
            <div className="w-[90%] md:w-[48%] h-full flex items-center flex-col justify-center">
